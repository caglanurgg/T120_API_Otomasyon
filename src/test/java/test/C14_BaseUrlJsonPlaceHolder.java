...
*/
    ...
    */
        ...
        //* dinamik bir yapi olusmasi icin
        //* (https://jsonplaceholder.typicode.com/) adresini Base URL'in icine tanimladik.
        //* eger olurda bir gun adresi degistirirlerse
        //*JsonPlaceBaseUrl'e gidip adresi degistirmem yeterli
        //* https://jsonplaceholder.typicode.com/ burdan sonraki path parametrelerini
        //* specJsonPlace'in sonuna eklemem lazim.

        //2- Expexcted Body hazırlamak
        //* Expexcted Body olmadigi icin hazirlamadik

        //3- Response Kaydetmek
        Response response=given().spec(specJsonPlace).when().get("/{pp1}");
        //* sana specJsonPlace isimli spesifik bir adres verdigim zaman
        //* git sonuna /{pp1} ekle
