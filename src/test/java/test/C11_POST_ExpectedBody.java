...
*/
    ...
    public void postExp(){
        ...
        expBody.put("bookingid",24); // bookingid'in 24 olmasini bekliyorum
        expBody.put("booking",reqBody);
        //benim bekledigim booking icinde benim gonderdiklerimin olmasi

        // beklentimin gönderdiğim ile gelenin aynısı olması olduğu için expData=reqBody
        ...
        //*ben sana contentType'i JSON olan bir veri gonderdigim zaman bu verinin
        //*body'sini olustur ve body'yi de reqBody'nin toString()'le
        //*yaziya cevrilmis halini url'e post et.


        //4- Assertion İslemi
        JsonPath resJP=response.jsonPath();
        //* 3.adimdan bir cevap aldim. aldigim cecvabı kontrol edecegim
        //* icine bakabilmek icinde onu bir kutunun icine koydum response'la
