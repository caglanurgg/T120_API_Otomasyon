...
public class C03_JSONDataOlusturma {
    ...
    public void JSONData(){
        JSONObject jsonData=new JSONObject(); //Json Objesi Olusturma
    ...
    @Test
    public void innerJson(){ // ic ice json

        JSONObject innerJSONObj=new JSONObject(); // 66.satir ile 69.satir arasi
